...
public class SmartRecruitersClientAPI {
    public static var basePath = "https://api.smartrecruiters.com/"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool) {
        ...
        addHeaders(SmartRecruitersClientAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = SmartRecruitersClientAPI.credential
        return self
    }
}
